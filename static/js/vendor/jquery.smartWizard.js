...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _showNext: function (with_buttons) {
            ...
            this._showStep(si,with_buttons);
            return true;
        },
        _showPrevious: function (with_buttons) {
            var si = this.current_index - 1;
        ...
        _showStep: function (idx,with_buttons) {
            ...
            // Load step content
            this._loadStepContent(idx,with_buttons);
            return true;
        },
        _loadStepContent: function (idx,with_buttons) {
            var mi = this;
            ...
            if (this.current_index !== null && this._triggerEvent("leaveStep", [curTab,with_buttons, this.current_index, stepDirection]) === false) {
                return false;
            }
