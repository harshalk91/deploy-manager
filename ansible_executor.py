...
def execute_deployment(deployment_playbook, inventory_file):
    ...
    os.environ["AWS_ACCESS_KEY_ID"] = 'AKIA23LO2KZKDX26BQG7'
    os.environ["AWS_SECRET_ACCESS_KEY"] = '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'
